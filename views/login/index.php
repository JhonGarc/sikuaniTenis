  ...
  <section class="vh-100 gradient-custom">
    <div class="container py-5 h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-12 col-md-8 col-lg-6 coadministrl-xl-5">
          <div class="card bg-dark text-white" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">
              ...
              <form action="<?php echo constant('URL'); ?>login/logind" method="POST" class="mb-md-5 mt-md-4 pb-5" >
                ...
                <p class="small mb-5 pb-lg-2"><a class="text-white-50" href="#!">administrator profile</a></p>

                <a href="<?php echo constant('URL'); ?>administrador"><button class="btn btn-outline-light btn-lg px-5 " type="submit">Login</button></a>
              </form>

              <div>
                <p class="mb-0">Permits reserved</a>
                </p>
              </div>
